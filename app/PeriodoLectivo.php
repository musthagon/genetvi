...
class PeriodoLectivo extends Model
{
    ...
    protected $fillable = ['id', 'nombre', 'descripcion', 'tipo_periodo_lectivo', 'opciones', 'fecha_inicio', 'fecha_fin', 'momento_evaluacion_activo_id','categoria_curso_id','created_at','updated_at'];
