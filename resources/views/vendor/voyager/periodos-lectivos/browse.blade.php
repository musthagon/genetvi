...
@section('page_title', __('Viendo').' '.$dataType->getTranslatedAttribute('display_name_plural'))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @if(isset($data->CategoriaDeCurso) && $data->CategoriaDeCurso->getPeriodoLectivo() == $data->getID())
                                                <a href="{{ route('deshabilitar_periodo_lectivo', ['categoria_id' => $data->CategoriaDeCurso->getID(), 'periodo_lectivo_id' => $data->getID() ]) }}" title=" Deshabilitar Periodo Léctivo" class="btn btn-sm btn-danger pull-right" style="margin-right: 5px;">
                                                    <i class="voyager-pause"></i> Deshabilitar Periodo Léctivo
                                                </a>
                                            @elseif(isset($data->CategoriaDeCurso))
                                                <a href="{{ route('habilitar_periodo_lectivo', ['categoria_id' => $data->CategoriaDeCurso->getID(), 'periodo_lectivo_id' => $data->getID() ]) }}" title="Habilitar Periodo Léctivo" class="btn btn-sm btn-success pull-right" style="margin-right: 5px;">
                                                    <i class="voyager-play"></i> Habilitar Periodo Léctivo
                                                </a>
                                            @endif
